...
<div id="wrapper">
  ...
  <div class="main-content">
    ...
    <section class="inner-header divider layer-overlay overlay-dark-5" data-bg-img="https://levane.in/wp-content/uploads/2022/12/contactus-banner.jpg" style="background-position: center!important;">
    ...
    <section class="divider">
        <div class="container">
          <div class="row mb-60">
            ...
            <div class="col-sm-12 col-md-4">
              <div class="contact-info text-center pt-40 pb-40  border-1px">
                ...
                <h4>Address</h4>
                <h6>Near SP Office Amingaon, Kamrup</h6>
                <h6>Guwahati, Assam - 781031</h6>
              </div>
            </div>
            <div class="col-sm-12 col-md-4">
              <div class="contact-info text-center pt-40 pb-40 border-1px">
          ...
          <div class="row pt-10">
            <div class="col-md-5">
            <h4 class="mt-0 mb-30 line-bottom">Our Location</h4>
            <div class="map">
                <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3580.071610483148!2d91.66840377449374!3d26.19434869059431!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x375a5aec3f0bc931%3A0x79e612164fa6cf06!2sGuwahati%20Biotech%20Park!5e0!3m2!1sen!2sin!4v1686917505067!5m2!1sen!2sin" width="600" height="430" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
            </div>
            </div>
            <div class="col-md-7">
              <h4 class="mt-0 mb-30 line-bottom">Query</h4>
              <!-- Contact Form -->
              <form id="contact_form" name="contact_form" class="" action="https://kodesolution.com/html/2016/landscaping-html/demo/includes/sendmail.php" method="post">
                ...
                <div class="form-group" style="margin-bottom:0;">
                    ...
                    <button type="submit" class="btn btn-dark btn-theme-colored mr-5" data-loading-text="Please wait...">Send your message</button>
                    <!-- <button type="reset" class="btn btn-default btn-theme-colored">Reset</button> -->
                    </div>
                </div>
              </form>

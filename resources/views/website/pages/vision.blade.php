    ...
    <section id="about">
        <div class="container pb-40">
          <div class="section-content">
            <div class="row">
              <div class="col-md-12">
                <h2 class="title-pattern1 mt-0 mb-30"><span class="title-pattern title-pattern-color mt-0 mb-30">2.1</span> <span>Vision</h2>
                <p style="text-align: justify;">The vision of this policy shall be to attain high capability in biotechnology education, research and commercialization and utilizing biotechnology to build up a sustainable industry ecosystem for creation of wealth, income generation, employment generation and promotion of equity.</p>
              </div>
            </div>
          </div>
        </div>

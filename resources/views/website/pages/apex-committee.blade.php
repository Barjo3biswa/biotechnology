            ...
            <div class="row">
              <div class="col-md-9">
                ...
                <ol class="ordered-list-padding" type="A">
                    ...
                    <li>The Director, Assam Biotechnology Council will be its member-secretary</li>
                    <li>The Apex Committee, shall also consist of other stake holders representatives.</li>
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-hover">
                      ...
                      <tbody>
                          <tr>
                              <td>1</td>
                              <td>Chief Minister to the Government of Assam</td>
                              <td>Chairperson</td>
                          </tr>
                          <tr>
                              <td>2</td>
                              <td>Minister in Charge, Science &amp; Technology Department,
                                Government of Assam</td>
                              <td>Vice Chairperson</td>
                          </tr>
                          <tr>
                              <td>3</td>
                              <td>Senior most Secretary of the Science and Technology Department</td>
                              <td>Member</td>
                          </tr>
                          <tr>
                              <td>4</td>
                              <td>Senior most Secretary of the Agriculture Department</td>
                              <td>Member</td>
                          </tr>
                          <tr>
                              <td>5</td>
                              <td>Senior most Secretary of the Finance Department</td>
                              <td>Member</td>
                          </tr>
                          <tr>
                              <td>6</td>
                              <td>Senior most Secretary of the Education Department</td>
                              <td>Member</td>
                          </tr>
                          <tr>
                              <td>7</td>
                              <td>Senior most Secretary of the Power Department</td>
                              <td>Member</td>
                          </tr>
                          <tr>
                              <td>8</td>
                              <td>Senior most Secretary of the Revenue Department</td>
                              <td>Member</td>
                          </tr>
                          <tr>
                              <td>9</td>
                              <td>Senior most Secretary of the Industries &amp; Commerce
                                Department</td>
                              <td>Member</td>
                          </tr>
                          <tr>

        ...
        <div class="row border-bottom-black">
            <div class="col-sm-6 col-md-3">
                <div class="widget dark">
                    ...
                    <p>To promote Assam as an attractive and competitive destination for investments in the
                        field of Biotechnology and allied areas.</p>
            ...
            <div class="col-sm-6 col-md-3">
                <div class="widget dark">
                    ...
                    <ul class="list angle-double-right list-border">
                        ...
                        <li><a href="#">Assam Biotechnological Council</a></li>
                    </ul>
                </div>
            </div>
            <div class="col-sm-6 col-md-3">
  ...
  <div class="widget dark">
    ...
    <div class="footer-bottom bg-black-333">
        <div class="container pt-20 pb-20">
            <div class="row">
                <div class="col-md-6">
                    <p class="font-11 text-black-777 m-0" style="color:#fff">Copyright &copy;2023 Assam
                        Biotechnology Council. All Rights Reserved.</p>
                </div>

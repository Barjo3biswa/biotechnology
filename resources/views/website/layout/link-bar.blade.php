      ...
      <div class="container pt-0 pb-0">
        <div class="gigw-guidlines-mobile">
          ...
          <div class="col-xs-4 col-sm-4 col-md-4">
              <div class="widget no-border m-0">
                <div class="mt-0 mb-0 flip sm-text-left gigw">
                  <div class="font-12 text-black-333 mb-0 font-weight-500"><a href="{{route('screen-reader')}}"><a>Screen Reader Access</a></div>
                </div>
              </div>
          </div>
        </div>
            ...
            <div class="col-sm-4 col-md-6">
              <div class="gigw-guidlines">
                ...
                <div class="col-xs-4 col-sm-4 col-md-4">
                    <div class="widget no-border m-0">
                      <div class="mt-0 mb-0 flip sm-text-left gigw">
                          <div class="font-12 text-black-333 mb-0 font-weight-500"><a href="{{route('screen-reader')}}">Screen Reader Access</a></div>
                      </div>
                    </div>
                </div>
              </div>
                ...
                <img src="images/logo-wide.png" alt="">
                    ...
                    <ul class="menuzord-menu" style="float:left;">
                        ...
                        <li class="{{Request::is('form')||Request::is('exe-committee')? 'active' : ''}}">
                            <a href="#">Apply Here</a>
                            <ul class="dropdown">
                                <li><a href="{{route('form')}}" target="_blank">APPLICATION FORM FOR AVAILING ASSISTANCE FOR START UPS</a></li>
